# Modified from https://github.com/librelane/librelane/blob/main/librelane/scripts/openroad/common/pdn_cfg.tcl
#
...
# MAIN CHANGE: Macro `Neuromorphic_X1_wb` has its top metal on `met3`
# rather than `met4`. As such, instead of connecting the `macro`
# power grid to `met4` to `met5`, connecting it from `met3` to `met4`
# at the bottom of this script.

# Otherwise, is the exact same the standard `pdn_cfg.tcl`.
